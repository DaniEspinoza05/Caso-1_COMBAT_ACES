...
public class PlayerController : MonoBehaviour
{
    ...
    private void OnCollisionEnter(Collision collision)
    {
        if (collision.gameObject.CompareTag("Enemy"))
        {
            ...
            StartCoroutine(DestroyPlayerAndQuit(collision.transform));
        }
    }

    private IEnumerator DestroyPlayerAndQuit(Transform enemyTransform)
    {
        ...
        playerCamera.target = tempObject.transform;
